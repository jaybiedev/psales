...
<SCRIPT type=text/javascript>
	...
	Menu1 = new Array("Files","", 11, 19, 100);
		Menu1_1 = new Array("Employee Master", "?p=paymast.browse", 0, 18, 180);
		Menu1_2 = new Array("Departments", "?p=department", 0, 15, 130);
		Menu1_3 = new Array("Sections", "?p=section", 0, 15, 130);
		Menu1_4 = new Array("Levels", "?p=level", 0, 15, 130);
		Menu1_5 = new Array("Position", "?p=position", 0, 15, 130);
		Menu1_6 = new Array("SSS Table", "?p=ssstable", 0, 15, 130);
		Menu1_7 = new Array("Philhealth Table", "?p=phictable", 0, 15, 130);
		Menu1_8 = new Array("Withholding Tax Table", "?p=wtaxtable", 0, 15, 130);
		Menu1_9 = new Array("Income Types", "?p=income_type", 0, 15, 130);
		Menu1_10 = new Array("Deduction Types", "?p=deduction_type", 0, 15, 130);
		Menu1_11 = new Array("", "", 0, 15, 150);
	Menu2 = new Array("Transaction","", 9, 20, 100);
		Menu2_1 = new Array("Payroll", "?p=payroll.transaction.browse", 0, 20, 180);
		Menu2_2 = new Array("Auto Generate", "?p=payroll.autogenerate", 0, 15, 120);
		Menu2_3 = new Array("Charges", "?p=payrollcharge", 0, 15, 150);
		Menu2_4 = new Array("Payroll Period", "?p=payroll_period", 0, 15, 130);
		Menu2_5 = new Array("Post(Close) Transactions", "?p=payroll.posting", 0, 15, 120);
		Menu2_6 = new Array("Recalculate Accounts", "?p=payroll.recalc.account", 0, 15, 120);
		Menu2_7 = new Array("", "", 0, 15, 150);
		Menu2_8 = new Array("Memo Entry", "?p=memo", 0, 15, 150);
		Menu2_9 = new Array("", "", 0, 15, 150);
	Menu3 = new Array("Reports","", 17, 20, 100);
		Menu3_1 = new Array("Employee Payslip", "?p=report.payslip", 0, 20, 180);
		Menu3_2 = new Array("Payroll Summary", "?p=report.payrollsummary", 0, 20, 140);
		Menu3_3 = new Array("ATM Report", "?p=report.atm", 0, 20, 180);
		Menu3_4 = new Array("Income Listing", "?p=report.income", 0, 15, 130);
		Menu3_5 = new Array("Deduction Listing", "?p=report.deduction", 0, 15, 130);
		Menu3_6 = new Array("Deduction Summary", "?p=report.deductionsummary", 0, 15, 130);
		Menu3_7 = new Array("SSS Summary", "?p=report.sss", 0, 15, 130);
		Menu3_8 = new Array("WTax Summary", "?p=report.wtax", 0, 15, 130);
		Menu3_9 = new Array("PHIC Summary", "?p=report.phic", 0, 15, 130);
		Menu3_10 = new Array("PagIbig Summary", "?p=report.pagibig", 0, 15, 130);
		Menu3_11 = new Array("13th Month Periodic", "?p=report.thirteenperiodic", 0, 15, 130);
		Menu3_12 = new Array("-------------------------------", "?p=", 0, 15, 130);
		Menu3_13 = new Array("Charges Listing", "?p=report.chargelist", 0, 15, 130);
		Menu3_14 = new Array("Charges Summary", "?p=report.chargesummary", 0, 15, 130);
		Menu3_15 = new Array("Employee Account Ledger", "?p=report.payrollaccountledger", 0, 15, 130);
		Menu3_16 = new Array("Employee Account Summary", "?p=", 0, 15, 130);
		Menu3_17 = new Array("", "", 0, 15, 150);

	Menu4 = new Array("Setup","", 10, 20, 100);
		Menu4_1 = new Array("Select Payroll Period", "?p=selectpayrollperiod", 0, 20, 180);
		Menu4_2 = new Array("Setup Payroll Period", "?p=payroll_period", 0, 20, 150);
		Menu4_3 = new Array("Payroll Summary Format", "?p=setup.payrollsummary", 0, 30, 130);
		Menu4_4 = new Array("Income Summary Format", "?p=setup.incomesummary", 0, 30, 130);
		Menu4_5 = new Array("Deduction Summary Format", "?p=setup.deductionsummary", 0, 30, 130);
		Menu4_6 = new Array("Charges Summary Format", "?p=setup.chargesummary", 0, 30, 130);
		Menu4_7 = new Array("-------------------------------", "?p=", 0, 15, 130);
		Menu4_8 = new Array("System Configuration", "?p=sysconfig", 0, 15, 130);
		Menu4_9 = new Array("Passwords", "?p=password", 0, 15, 130);
		Menu4_10 = new Array("", "", 0, 15, 130);
