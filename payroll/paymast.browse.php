<br><form name="form1" method="post" action="">
  ...
  <table width="85%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#EFEFEF">
    ...
    <tr> 
      ...
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=paymast.browse&p1=Go&sortby=stock&start=<?=$start;?>&search=<?=$search;?>&searchby=<?=$searchby;?>">Employee</a></font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=paymast.browse&p1=Go&sortby=unit&start=<?=$start;?>&search=<?=$search;?>&searchby=<?=$searchby;?>">Branch</a></font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=paymast.browse&p1=Go&sortby=unit&start=<?=$start;?>&search=<?=$search;?>&searchby=<?=$searchby;?>">Department</a></font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=paymast.browse&p1=Go&sortby=classification_id&start=<?=$start;?>&search=<?=$search;?>&searchby=<?=$searchby;?>">Position</a></font></td>
