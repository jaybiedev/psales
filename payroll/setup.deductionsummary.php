	...
	while ($ctr < count($mark))
	{
		...
		if ($seqn[$c]!='')
		{
			...
			if ($reportform_id[$c] == '')
			{
				...
				{
					$q = "select * from reportform where reportform='DEDUCTSUM' and reportform_code = '".$reportform_code[$c]."'";
				...
				$q = "insert into reportform (reportform, enable, reportform_code, title1, title2, type, seqn, long)
						values ('DEDUCTSUM', '".$enable[$c]."','".$reportform_code[$c]."','".$title1[$c]."', '".$title2[$c]."','".$type[$c]."', '".$seqn[$c]."', '".$long[$c]."')";
...
<form name="form1" id="f1"  method="post" action="">
  <table width="50%" border="0" cellspacing="1" cellpadding="0" bgcolor="#E9E9E9" align="center">
    <tr bgcolor="#C8D7E6"> 
      <td height="27" colspan="13" background="../graphics/table0_horizontal.PNG"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
        ...
        Deduction Summary Reportform </font></strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
	...
	$q = "select * from reportform where reportform='DEDUCTSUM' ";
	if ($xSearch != '')
	{
  ...
  <p align="center"><font size="1">*Reserved Codes: SSS - Social Security; PHIC 
    - PhilHealth; PAGIBIG - Pag-Ibig; WTAX-Withholding Tax</font></p>
</form>
<div align="center">
