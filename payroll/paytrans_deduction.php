 <div id='payroll_deduction' style='position:absolute; width:100%; height:100%; z-index:1; overflow: auto; background-color: #FFFFFF; layer-background-color: #FFFFFF; border: 1px none #000000; visibility: hidden;'>
   <table width="100%" cellpadding="0" cellspacing="1" border="0" bgcolor="#000033">
      ...
      <td colspan="2" width="43%"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;Deduction 
        Type</font></strong></td>
	...
	<tr  height="50"> 
      ...
      <td colspan="6" bgcolor="#ADC8E4"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#000033"> 
        ...
        <input name='p4' type='submit' id="p4" value='Select'>
        ...
        <?
			...
			$q = "select paytrans_type, paytrans_type_id 
					from paytrans_type where type='D' ";
        ...
        <input name='p2' type='submit' id="p2" value="<?= ($p1=='Edit' ? 'Update' : 'Insert');?>">
        </font></strong> </td>
    </tr>
