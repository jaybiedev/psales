  ...
  <tr bgcolor="#F0F0F0"> 
    <td width="14%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Birth 
      Date</font></td>
    <td width="29%"> <input name="date_birth" type="text" id="date_birth" value="<?= ymd2mdy($paymast['date_birth']);?>" size="12" onBlur="IsValidDate(this,'MM/dd/yyyy')" onKeyUp="setDate(this,'MM/dd/yyyy','en')"  onKeypress="if(event.keyCode==13) {document.getElementById('gender').focus();return false;}"> 
      <img src="../graphics/dwn-arrow-grn.gif" width="12" height="12" onClick="popUpCalendar(this, f1.date_birth, 'mm/dd/yyyy')"> 
    </td>
    <td width="14%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">SSS 
      Id</font></td>
  ...
  <tr> 
    ...
    <td colspan="3" bgcolor="#F0F0F0"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
