  ...
  $aip = explode('.',$_SERVER['REMOTE_ADDR']);
	...
	if ($p1=="Go" || $p1=='Print Draft' ||  $p1=='Print') 
	{
		...
		$q = "select
			...
			if( !empty($from_category_id) && !empty($to_category_id)){

				if ($from_category_id != '') $from_category_name = trim(lookUpTableReturnValue('x','category','category_id','category',$from_category_id));
				if ($to_category_id   != '') $to_category_name = trim(lookUpTableReturnValue('x','category','category_id','category',$to_category_id));

				$header .= "From Category : [$from_category_name] $account\n";
				$header .= "To Category : [$to_category_name] $account\n";
			}
...
<form name='form1' method='post' action=''>
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2">
    <tr bgcolor="#EFEFEF"> 
      <td height="24" colspan="6" background="../graphics/table0_horizontal.PNG"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
    ...
    <tr bgcolor="#EFEFEF"> 
      ...
      <td style="width:10%;"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">From Category</font></td>
      <td style="width:10%;"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif">To Category</font></td>
	...
	?>
    <tr> 
      <td colspan="6"><br> <table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#EFEFEF">
          <tr bgcolor="#FFCCFF"> 
	...
	?>
    <tr bgcolor="#DADADA"> 
      <td colspan="6"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Report 
        Preview 
        <?
    ...
    <tr> 
      <td colspan="6"><textarea name="print_area" cols="110" readOnly rows="20" wrap="OFF" style="width:100%;"><?= $details1;?></textarea></td>
    </tr>
    <?
	}
	?>
