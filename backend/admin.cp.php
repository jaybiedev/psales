...
<form name="form1" method="post" action="">
  <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td><input name="mpassword_confirm" type="password" id="mpassword_confirm"   onKeypress="if(event.keyCode==13) {document.getElementById('p1').focus();return false;}"></td>
    </tr>
    <tr> 
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr> 
      <td colspan="2"><input name="p1" type="submit" id="p1" value="Change Password"> 
        <input name="p12" type="button" id="cancel" value="Cancel" onClick="window.location='?p='">
        <input name="p13" type="button" id="close" value="Close" onClick="window.location='?p='"></td>
    </tr>
  </table>
</form>
