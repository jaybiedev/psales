...
$fields = array("IP","DESCRIPTION","TERMINAL","AREA_ID","CASHIERING", "SERIAL","RECEIPT_PRINTER_DEST","RECEIPT_PRINTER_TYPE","REPORT_PRINTER_DEST",
				"REPORT_PRINTER_TYPE", "DRAWER","DISPLAY","CUTTER","EXTRA","DATE_TRANSACTION","MACHINENO","PERMITNO","ENABLE",'ALLOW_MUL_QTY');
...
if (!in_array($p1, array('Load','Edit','Print','New')))
{
	for ($c=0;$c<count($fields);$c++)
	{
		...
		{
			$aTERMD[$fields[$c]] = mdy2ymd($_REQUEST[$fields[$c]]);
		}
		else
		{
...
&nbsp;<img src="../graphics/b_edit.png" width="16" height="16"> 
  ...
  <tr> 
    <td width="29%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">IP 
      Addr</font></td>
    <td width="71%"> 
      <input name="IP" type="text" id="IP" value="<?= $aTERMD['IP'];?>">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Description</font></td>
    <td> 
      <input name="DESCRIPTION" type="text" id="DESCRIPTION" value="<?= $aTERMD['DESCRIPTION'];?>">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Terminal No.</font></td>
    <td> 
      <input name="TERMINAL" type="text" id="TERMINAL" value="<?= $aTERMD['TERMINAL'];?>">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Area </font></td>
    <td> 
      <?= lookUpTable2('AREA_ID','area','area_id','area',$aTERMD['AREA_ID']);?>    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Allow Cashiering</font></td>
    <td>
      <?= lookUpAssoc('CASHIERING',array('No'=>'N','Yes'=>'Y'),$aTERMD['CASHIERING']);?>    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Serial No.</font></td>
    <td> 
      <input name="SERIAL" type="text" id="SERIAL" value="<?= $aTERMD['SERIAL'];?>">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Receipt Print 
      Destination</font></td>
    <td> 
      <input name="RECEIPT_PRINTER_DEST" type="text" id="RECEIPT_PRINTER_DEST" value="<?= $aTERMD['RECEIPT_PRINTER_DEST'];?>">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Receipt Type</font></td>
    <td> 
      <?=lookUpAssoc('RECEIPT_PRINTER_TYPE',array('NONE'=>'NONE', 'UDP Draft PRINTER'=>'UDP DRAFT','TCP Draft PRINTER'=>'TCP DRAFT','GRAPHIC'=>'GRAPHIC','LINUX LP Printer'=>'LINUX LP Printer','PHP Printer(DRAFT)'=>'PHP Printer(DRAFT)','PHP Printer(TEXT)'=>'PHP Printer(TEXT)'),$aTERMD['RECEIPT_PRINTER_TYPE']);?>    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Report Print 
      Destination</font></td>
    <td> 
      <input name="REPORT_PRINTER_DEST" type="text" id="REPORT_PRINTER_DEST" value="<?= $aTERMD['REPORT_PRINTER_DEST'];?>">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Report Type</font></td>
    <td> 
      <?=lookUpAssoc('REPORT_PRINTER_TYPE',array('NONE'=>'NONE',  'UDP Draft PRINTER'=>'UDP DRAFT','TCP Draft PRINTER'=>'TCP DRAFT','Linux LP Printer'=>'LINUX LP Printer','GRAPHIC'=>'GRAPHIC','PHP Printer(DRAFT)'=>'PHP Printer(DRAFT)','PHP Printer(TEXT)'=>'PHP Printer(TEXT)'),$aTERMD['REPORT_PRINTER_TYPE']);?>    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Drawer</font></td>
    <td> 
      <?=lookUpAssoc('DRAWER',array('NONE'=>'NONE', 'COM1'=>'COM1','COM2'=>'COM2','COM3'=>'COM3','LPT'=>'LPT'),$aTERMD['DRAWER']);?>    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Customer Display</font></td>
    <td> 
      <?=lookUpAssoc('DISPLAY',array('NONE'=>'NONE', 'COM1'=>'COM1','COM2'=>'COM2','COM3'=>'COM3','LPT'=>'LPT'),$aTERMD['DISPLAY']);?>    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Printer Auto Cutter</font></td>
    <td> 
      <?= lookUpAssoc('CUTTER',array('Yes'=>'Y','No'=>'N'), $aTERMD['CUTTER']);?>    </td>
  </tr>
  <tr>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Machine Number </font></td>
    <td><input name="MACHINENO" type="text" id="MACHINENO" value="<?= $aTERMD['MACHINENO'];?>" /></td>
  </tr>
  <tr> 
   <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Permit Number </font></td>
    <td><input name="PERMITNO" type="text" id="PERMITNO" value="<?= $aTERMD['PERMITNO'];?>" /></td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Extra</font></td>
    <td> <input name="EXTRA" type="<?= ($ADMIN['usergroup'] == 'A' ? 'text' : 'hidden');?>" id="EXTRA" value="<?= $aTERMD['EXTRA'];?>" size="10">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Transaction 
      Date </font></td>
    <td> <input name="DATE_TRANSACTION" type="<?= ($ADMIN['usergroup'] == 'A' ? 'text' : 'hidden');?> <?= ($ADMIN['usergroup'] != 'A' ? 'ReadOnly' : '');?>" id="DATE_TRANSACTION" value="<?= ymd2mdy($aTERMD['DATE_TRANSACTION']);?>" size="10" onBlur="IsValidDate(this,'MM/dd/yyyy')" onKeyUp="setDate(this,'MM/dd/yyyy','en')" >
      <img src="../graphics/dwn-arrow-grn.gif" onclick="popUpCalendar(this, f1.DATE_TRANSACTION, 'mm/dd/yyyy')">    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Enabled</font></td>
    <td> 
      <?= lookUpAssoc('ENABLE',array("Yes"=>"Y","No"=>"N"),$aTERMD['enable']);?>    </td>
  </tr>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Allow Mul Qty</font></td>
    <td> 
      <? if ( empty( $aTERMD['ALLOW_MUL_QTY'] ) ) $aTERMD['ALLOW_MUL_QTY'] = "N"; ?>
      <?= lookUpAssoc('ALLOW_MUL_QTY',array("Yes"=>"Y","No"=>"N"),$aTERMD['ALLOW_MUL_QTY']);?>    </td>
  </tr>
  <tr> 
    <td colspan="2"> 
      <table width="1%" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
        <tr bgcolor="#FFFFFF"> 
          ...
          <td nowrap width="25%"> <img  src="../graphics/browse.gif"  name="New" id="New" onClick="window.location='?p=../backend/terminal'" alt="Browse Terminals" width="68" height="18" accesskey="B">          </td>
        </tr>
      </table>    </td>
  </tr>
</table>
