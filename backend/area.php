...
<form name="form1" method="post" action="">
  <table width="60%" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr bgcolor="#E9E9E9"> 
      <td width="48%" rowspan="2"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">#</font></td>
      <td width="11%" rowspan="2" nowrap><a href="<?=$href.'&sort=area&start=$start&xSearch=$xSearch';?>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Area</font></a></td>
      <td width="3%" rowspan="2" nowrap><a href="<?=$href.'&sort=area_code&start=$start&xSearch=$xSearch';?>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Code</font></a></td>
      <td width="9%" rowspan="2" nowrap><a href="<?=$href.'&sort=department&start=$start&xSearch=$xSearch';?>"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Department</font></a></td>
      <td colspan="2" nowrap><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Category 
        Sales </font></td>
      <td width="15%" rowspan="2" nowrap><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
    ...
    <tr bgcolor="#E9E9E9"> 
      <td width="3%" align="center" nowrap><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">From</font></td>
      <td width="11%" align="center" nowrap><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">To</font></td>
    </tr>
    <?
	if ($p1=='Insert')
	{
    ...
    <tr bgcolor="#FFFFFF" onMouseOver="bgColor='#FFFFCC'" onMouseOut="bgColor='#FFFFFF'"> 
      ...
      <td> <input   type="text"  class="altText" name="area[]" size="30"  onChange="vChk(this)" id="<?='t'.$c;?>"> 
      </td>
      <td ><input name="area_code[]"   type="text"  class="altText" id="<?='k'.$c;?>"  onChange="vChk(this)" size="5" maxlength="5"> 
      </td>
      <td > 
        <?=lookUpAssoc('department[]',array('Grocery'=>'G','Dry Goods'=>'D','N/A'=>'N'),'');?>
      </td>
      <td ><input name="from_category[]"   type="text"  class="altText" id="<?='k'.$c;?>"  onChange="vChk(this)" size="5" maxlength="5"></td>
      <td ><input name="to_category[]"   type="text"  class="altText"  id="<?='k'.$c;?>"  onChange="vChk(this)" size="5" maxlength="5"></td>
      <td> 
    ...
    <tr  bgcolor=<?= ($r->enable=='N')? '#FFCCCC' :'#FFFFFF';?>> 
      ...
      <td> <input name="area[]"   type="text"  class="altText" id="<?='t'.$ctr;?>"  onChange="vChk(this)" value="<?= $r->area;?>" size="30"> 
      </td>
      <td><input name="area_code[]"   type="text"  class="altText" id="<?='k'.$ctr;?>"  onChange="vChk(this)" value="<?=$r->area_code;?>" size="5" maxlength="5"> 
      </td>
      <td> 
        <?=lookUpAssoc('department[]',array('Grocery'=>'G','Dry Goods'=>'D','N/A'=>'N'),$r->department);?>
      </td>
      <td><input name="from_category[]"   type="text"  class="altText"  id="<?='k'.$ctr;?>"  onChange="vChk(this)" value="<?= $r->from_category;?>" size="5" maxlength="5"></td>
      <td><input name="to_category[]"   type="text"  class="altText"   id="<?='k'.$ctr;?>"  onChange="vChk(this)" value="<?= $r->to_category;?>" size="5" maxlength="5"></td>
      <td> 
