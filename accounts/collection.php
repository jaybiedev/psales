...
<form action="" method="post" name="f1" id="f1" style="margin:10px">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#BBCBE6">
    <tr> 
      ...
      <td width="99%" background="../graphics/table_horizontal.PNG"><font color="#FFFF99" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Payment 
        of Account</strong></font> </td>
...
<?	
 ...
 ?>
  <table width="90%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#DADADA">
    ...
    <tr> 
      <td height="22"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Interest/Surcharges</font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
    ...
    <tr> 
      <td colspan="2" bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Payment 
        &nbsp;</strong></font></td>
    </tr>
    <tr> 
