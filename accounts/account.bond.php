...
<form action="?p=account.bond" method="post" name="f1" id="f1" style="margin:10px">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td width="99%" background="../graphics/table_horizontal.PNG"><font color="#FFFF99" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Bond 
        Credit Memo Posting</strong></font></td>
      <td width="0%" background="../graphics/table_right.PNG">&nbsp; </td>
    </tr>
    <tr bgcolor="#DDE5F3"> 
      <td height="50" colspan="3"><font size="2">Search Account</font> 
        ...
        </font> <input name="p1" type="submit" id="p1" value="Go"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
 ...
 ?>
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#DADADA"> 
      ...
      <td width="9%" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">CrossRef</font></td>
      <td width="7%" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Type</font></td>
      <td width="8%" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Add</font></td>
      <td nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Less</font></td>
    </tr>
    <tr> 
      <td nowrap><b> 
      ...
      <td> <select name="type" id="type"  onKeypress="if(event.keyCode==13) {document.getElementById('debit').focus();return false;}">
          <option value="D" <?= ($aBond['type'] == 'D' ?'selected' : '');?>>Deposit</option>
          <option value="I" <?= ($aBond['type'] == 'I' ?'selected' : '');?>>Interest</option>
          <option value="W" <?= ($aBond['type'] == 'W' ?'selected' : '');?>>Withdrawal</option>
        </select> </td>
  ...
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#EFEFEF"> 
      ...
      <td width="11%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Reference</font></td>
      <td width="11%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">CrossRef</font></td>
      <td width="6%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Type</font></td>
      <td width="17%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Add</font></td>
      <td width="13%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Less</font></td>
      <td width="13%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Balance</font></td>
      <td width="13%">&nbsp;</td>
    </tr>
    <?
		if ($aBOND['account_id'] != '')
    ...
    <tr bgColor="<?=$bgColor;?>"> 
      ...
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <?= str_pad($r->bondledger_id,8,'0',str_pad_left);?>
        </font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <?= $r->reference;?>
        </font></td>
