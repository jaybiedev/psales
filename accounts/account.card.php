  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#EFEFEF">
    ...
    <tr> 
      <td width="15%" bgcolor="#CCCCCC"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Expiry 
        Date </font></b></td>
      <td width="32%" bgcolor="#CCCCCC"> <b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Date 
        Renewed </font></b></td>
      <td width="16%" bgcolor="#CCCCCC"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Encoder</font></b></td>
      <td width="37%" bgcolor="#CCCCCC"> <b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Remarks</font></b></td>
    </tr>
    <tr> 
      <td width="15%">&nbsp;</td>
      <td width="32%">&nbsp;</td>
