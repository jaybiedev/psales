...
<table width="80%" border="1" align="center" cellpadding="2" cellspacing="1" bgcolor="#EFEFEF">
<tr><td>
	<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#DADADA">
  <tr background="../graphics/table0_horizontal.PNG"> 
    <td bgcolor="#CCCCCC" ><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">#</font></strong></td>
    <td bgcolor="#CCCCCC"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Barcode</font></strong></td>
    <td bgcolor="#CCCCCC"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Item 
      Description</font></strong></td>
    <td bgcolor="#CCCCCC"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Price</font></strong></td>
    <td bgcolor="#CCCCCC"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Enable</font></strong></td>
  </tr>  
<?
	$ctr=0;
	while ($r = pg_fetch_object($qr))
	{
		...
		if ($r->stock_description == '') $stock_description = $r->stock;
		else $stock_description = $r->stock_description;	
  ?>

<tr bgcolor="#EFEFEF" onMouseOver="bgColor='#FFFFDD'" onMouseOut="bgColor='#EFEFEF'"> 
  ...
  ?>
  <tr bgcolor="#EFEFEF"> 
    <td colspan="5"><input type="button" name="Submit22" value="Add New" onClick="window.location='?p=stockpcenter&p1=New'"> 
