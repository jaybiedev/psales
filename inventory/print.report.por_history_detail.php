...
<body>
	...
	<table style="width:100%;">
        ...
        $q = "
            select 
                date, h.por_header_id, h.rr_header_id, h.reference, h.internal_reference, h.account_id, terms, stock, d.case_qty, d.unit_qty, d.cost1, d.cost3, amount
            from 
                por_header as h, por_detail as d, stock as p
            where 
        ...
        $q .= " order by date asc, h.por_header_id asc";
