...
<form name="form1" id="form1" method="post" action="">
    <div align="center">
        <table width="90%" border="0" cellspacing="1" cellpadding="0" bgcolor="#FFFFFF">
            <tr bgcolor="#EFEFEF"> 
	            <td nowrap style="font-weight:bold; font-family:Arial, Helvetica, sans-serif; font-size:13px; padding:3px;">POR HISTORY SUMMARY</td>       
            </tr>
            <tr> 
                <td nowrap>
            ...
            <? if ($p1=='Go') { ?>
	     	<tr>
				<td>
                    <iframe id="JOframe" name="JOframe" frameborder="0" width="100%" height="500" src="print.report.por_history.php?account_id=<?=$account_id?>&from_date=<?=$from_date?>&to_date=<?=$to_date?>">
                    </iframe>
