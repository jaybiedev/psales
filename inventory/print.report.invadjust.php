...
function getData($from_date,$to_date){
	$sql  = "
		select 
			h.*, d.*, s.stock, s.barcode, s.unit1, s.unit3
		from
			invadjust_header as h 
			inner join invadjust_detail as d on h.invadjust_header_id = d.invadjust_header_id
...
<body>
	<div style="font-weight:bold;">
		...
		echo "
			$business_name <br>
			INVVENTORY ADJUSTMENTS HISTORY <br>
			...
			foreach ($arr as $r) {
				...
				echo "
					<tr>
						...
						<td>".str_pad($r['invadjust_header_id'],7,0,STR_PAD_LEFT)."</td>																	
						<td>$r[stock]</td>						
