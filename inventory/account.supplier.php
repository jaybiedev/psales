  ...
  <table width="85%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#EFEFEF">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="17%" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Account 
        No.</font></td>
      <td width="42%"><input name="account_code" type="text" id="account_code" value="<?= $asupplier['account_code'];?>" size="15" maxlength="15"  onChange="xajax_vAcctno(xajax.getFormValues('f1'))" onKeypress="if(event.keyCode==13) {document.getElementById('account').focus();return false;}"> 
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; </font> </td>
      <td width="13%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Account 
        Type </font></td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Name 
        of account</font></td>
      <td><input name="account" type="text" id="account" value="<?= $asupplier['account'];?>" size="40" maxlength="40" onKeypress="if(event.keyCode==13) {document.getElementById('address').focus();return false;}"></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td rowspan="2" valign="top" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Address</font></td>
      <td rowspan="2"><textarea name="address" cols="40" rows="2" id="address" onKeypress="if(event.keyCode==13) {document.getElementById('telefax').focus();return false;}"><?= $asupplier['address'];?></textarea></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td colspan="3"><input name="telefax" type="text" id="telefax" value="<?= $asupplier['telefax'];?>" size="15" maxlength="15"onKeypress="if(event.keyCode==13) {document.getElementById('telno').focus();return false;}"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Telephone</font></td>
      <td colspan="3"><input name="telno" type="text" id="telno" value="<?= $asupplier['telno'];?>" size="15" maxlength="15" onKeypress="if(event.keyCode==13) {document.getElementById('terms').focus();return false;}"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td valign="top" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Terms</font></td>
      <td colspan="3"> 
        <input name="terms" type="text" id="terms" value="<?= $asupplier['terms'];?>" size="15" maxlength="15" onKeypress="if(event.keyCode==13) {document.getElementById('tin').focus();return false;}"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td valign="top" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">TIN</font></td>
      <td colspan="3"><input name="tin" type="text" id="tin" value="<?= $asupplier['tin'];?>" size="30" maxlength="30"  onKeypress="if(event.keyCode==13) {document.getElementById('remarks').focus();return false;}"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td valign="top" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Remarks</font></td>
      <td colspan="3"><textarea name="remarks" cols="40" id="remarks" onKeypress="if(event.keyCode==13) {document.getElementById('Save').focus();return false;}"><?= $asupplier['remarks'];?></textarea></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
