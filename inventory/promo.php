<form name="f1" method="post" action="">
  ...
  <table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#EFEFFEF">
    <tr bgcolor="#EFEFEF"> 
      <td colspan="9"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Filter 
        ...
        <input name="p1" type="submit" id="go" value="Go"> <input name="p12" type="button" id="p12" value="Generate New" onClick="window.location='?p=promo.generate&p1=New'"></td>
    ...
    <tr bgcolor="#CCCCCC"> 
      <td width="5%"><font size="1" face="Times New Roman, Times, serif"><strong>#</strong></font></td>
      <td width="27%"><font size="1" face="Times New Roman, Times, serif"><strong>Supplier</strong></font></td>
      <td width="10%"><font size="1" face="Times New Roman, Times, serif"><strong>From</strong></font></td>
      <td width="10%"><font size="1" face="Times New Roman, Times, serif"><strong>To</strong></font></td>
      <td width="8%"><font size="1" face="Times New Roman, Times, serif"><strong>Supplier</strong></font></td>
      <td width="8%"><font size="1" face="Times New Roman, Times, serif"><strong>Company</strong></font></td>
      <td width="6%"><font size="1" face="Times New Roman, Times, serif"><strong>Items</strong></font></td>
      <td width="6%"><font size="1" face="Times New Roman, Times, serif"><strong>Cust</strong></font></td>
      <td width="10%"><font size="1" face="Times New Roman, Times, serif"><strong>Status</strong></font></td>
      <td width="10%"><font size="1" face="Times New Roman, Times, serif"><strong>Audit</strong></font></td>
      <td width="10%"><font size="1" face="Times New Roman, Times, serif">&nbsp;</font></td>
    </tr>
    <?
		if ($p1 == 'Toggle' && $id != '')
		{
    ...
    <tr valign="top" bgcolor="<?=$bgColor;?>"  onMouseOver="bgColor='#FFCCCC'" onMouseOut="bgColor='<?=$bgColor;?>'"> 
      <td align="right"><font size="1" face="Times New Roman, Times, serif"> 
        <?= $ctr;?>
        .</font></td>
      <td><font size="1" face="Times New Roman, Times, serif"> <a href="?p=promo.generate&p1=Load&id=<?= $r->promo_header_id;?>"> 
        <?= $r->account;?>
        </a></font></td>
      ...
      <td nowrap> <font size="1" face="Times New Roman, Times, serif"> <a href="javascript:if(confirm('Are you sure to Toggle Status?')){f1.action='?p=promo&p1=Toggle&id=<?=$r->promo_header_id;?>';f1.submit()}"> 
