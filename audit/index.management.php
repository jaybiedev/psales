...
<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#999999">
  <tr bgcolor="#CCCCCC"> 
    <td width="11%" height="19" align="center" nowrap onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'"> 
      <a accesskey="Z" href="?p=report.zread"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Z-Reading</font></a></td>
    <td width="11%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a  accesskey="H" href="../?p=logout">Logout</a></font></td>
    <td width="47%">&nbsp;</td>
  </tr>
</table>
<?php
