...
<form action="" method="post" name="f1" id="f1">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
        <input name="date" type="text" id="date" size="10" value="<?=$date;?>">
        </font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <input name="qty" type="text" id="qty" size="5" value="<?=$qty;?>">
        </font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <input name="amount" type="text" id="amount" size="10" value="<?=$amount;?>">
        </font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <input name="barcode" type="text" id="barcode" size="15" value="<?=$barcode;?>">
 ...
 if ($aRep['process'] =='go')
  ...
  <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#EFEFEF">
    <tr> 
      ...
      <td width="5%"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Status</font></strong></td>
      <td width="35%"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Audit</font></strong></td>
      <td width="9%">&nbsp;</td>
    </tr>
    <?
	$ctr=0;
    ...
    <tr bgcolor="#FFFFFF" onMouseOver="bgColor='#FFFFCC'" onMouseOut="bgColor='#FFFFFF'"> 
      ...
      <td align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <a href="?p=cashier.invoice&p1=choose&id=<?= $r['sales_header_id'];?>"> 
        <?= $r['invoice'];?>
        </a> </font></td>
      <td align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
...
if ($aRep['sales_header_id_chosen_id'] != '')
{
  ...
  <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#EFEFEF">
    ...
    <tr> 
      <td width="6%" align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">#</font></strong></td>
      <td width="9%"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Qty</font></strong></td>
      <td width="15%" align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Barcode</font></strong></td>
      <td width="33%"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        Description</font></strong></td>
      <td width="11%"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Price</font></strong></td>
