...
Today is 
  <?=date("l F j, Y g:ia").'</br> User@'.lookUpTableReturnValue('x','area','area_id','area',$r->value).' '.$terminal;?>
    <p>
  <h3>Press [ F11 ] Now To View FULL SCREEN
   <?
      ...
      <td> 
        <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#E2E2E2">
          ...
          <tr bgcolor="#EFEFEF"> 
            ...
            <td width="56%"> <input type="text" name="username" id="username"  onKeypress="if(event.keyCode==13) {document.getElementById('mpassword').focus();return false;}"> </td>
          </tr>
          <tr bgcolor="#EFEFEF"> 
...
<address>
<center>
  <img src="../graphics/elephantSmall.gif" width="50" height="50"> <img src="../graphics/php-small-whitee.gif" width="88" height="31"><img src="../graphics/worm_in_hole.gif" width="23" height="33"><br>
