  ...
  <tr valign="top"> 
    ...
    <td bgColor="#FFFFFF"> <table width="100%" height="125%" border="0" cellpadding="3" cellspacing="1" bgcolor="#EFEFEF">
        ...
        <tr valign="middle" bgcolor="#FFFFFF"> 
          ...
          <td width="33%" align="center" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=report.category">Daily 
        ...
        <tr valign="middle" bgcolor="#FFFFFF"> 
          <td height="34" align="center" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=report.monthly">Monthly 
            Sales</a></font></td>
          <td align="center" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=report.monthlydept">Monthly 
            Sales by Dept</a></font></td>
          <td align="center" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=report.changeprice">Changed 
            Price </a> </font></td>
        </tr>
        <tr valign="middle" bgcolor="#FFFFFF"> 
