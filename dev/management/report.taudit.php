...
<form name="form1" method="post" action="">
  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="0">
    ...
    <tr> 
	 ...
	 <input type="submit" name="p1" value="Go"> <input type="submit" name="p1" value="Print Draft"> </font>
        <hr color="#CC0000"> </td>
    </tr>
    <tr>
      <td height="28" bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Report Preview</strong></font></td>
    </tr>
    <tr>
