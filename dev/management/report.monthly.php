...
if ($p1 == 'Go' || $p1 == 'Print' || $p1 == 'Print Draft')
{
	...
	$header .= space(10)."------------ ----------  -------------  ---------------\n";
	$header .= space(10)."  Month      Count         Ave. Sales     Total Sales  \n";
	$header .= space(10)."------------ ----------  -------------  ---------------\n";
	$details = $details1 = '';
	$details1 = $header;
...
<hr color="#993300"></td>
  ...
  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="1">
    ...
    <tr> 
	  ...
	  {
	  	echo "<IFRAME SRC='graph.monthly.php' name='print_area' TITLE='Sales' WIDTH=750 HEIGHT=370 FRAMEBORDER=0></IFRAME>";
	  }
	  else
	  {
