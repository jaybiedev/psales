...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EFEFEF">
  <tr align="center" bgcolor="#FFFFFF"> 
    ...
    <td background="../graphics/table0_horizontal.PNG"><font color="#FFFFFF" size="5"><strong>Inventory 
      Reports Submenu</strong></font></td>
    ...
    <td bgColor="#FFFFFF"> <table width="100%" height="125%" cellpadding="3" cellspacing="1" bgcolor="#EFEFEF">
        <tr align="center" valign="middle" bgcolor="#FFFFFF"> 
          <td width="33%" height="32" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
            <a href="?p=report.inventory">Inventory Listing</a></font></td>
          <td width="33%" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
            <a href="?p=report.inventoryledger">Inventory Ledger</a></font></td>
          <td width="33%" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
            <a href="?p=report.inventorybalance">Inventory Balance</a></font></td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#FFFFFF"> 
          <td width="33%" height="34" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
            <a href="?p=report.srr">SRR Report</a></font></td>
          <td width="33%" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; 
            <a href="?p=report.porder">PO Report</a> </font></td>
          <td width="33%" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; 
            </font></td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#FFFFFF">
          <td height="34" onMouseOver="bgColor='#FFFFCC'" OnMouseOut="bgColor='#FFFFFF'"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a href="?p=report.bincard">StockCard</a></font></td>
