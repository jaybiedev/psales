...
if ($p1=="Save Checked")
{
	...
	while ($ctr < count($mark))
	{
		...
		if ($area[$c]!='')
		{
			if ($area_id[$c] == '')
			{
				$q = "insert into area (enable, area, area_code, department)
					values
...
<form name="form1" method="post" action="">
  ...
  <table width="60%" border="0" cellspacing="1" cellpadding="2" bgcolor="#EFEFEF" align="center">
    ...
    <tr bgcolor="#E9E9E9"> 
      ...
      <td width="31%" nowrap><a href="<?=$href.'&sort=area&start=$start&xSearch=$xSearch';?>"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Area</font></b></a></td>
      <td width="7%" nowrap><a href="<?=$href.'&sort=area_code&start=$start&xSearch=$xSearch';?>"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Code</font></b></a></td>
      <td width="15%" nowrap><a href="<?=$href.'&sort=department&start=$start&xSearch=$xSearch';?>"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000">Department</font></b></a></td>
