...
<form name="fd" id="fd" method="post" action="">
  <table width="80%" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr bgcolor="#EFEFEF" background="../graphics/table0_horizontal.PNG"> 
      <td height="26" colspan="4"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;<img src="../graphics/list3.gif"> 
    ...
    <tr background="#EFEFEF"> 
      ...
      <td width="6%" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Grace 
        Period </font></td>
      <td width="6%" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Posting</font></td>
      <td width="78%" nowrap><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Account 
