...
if ($p1=="Save Checked")
{
	...
	while ($ctr < count($mark))
	{
		...
		if ($tender[$c]!='')
		{
			...
			if ($tender_id[$c] == '')
			{
				$q = "insert into tender (enable, bankable, tender_type, service_grocery, dry_good, tender_code, seq, tender,extra)
							values ('".$enable[$c]."','".$bankable[$c]."','".$tender_type[$c]."','".$service_grocery[$c]."','".$service_drygood[$c]."',
							'".$tender_code[$c]."','".$seq[$c]."','".$tender[$c]."','".$extra[$c]."')";
...
<form name="form1" method="post" action="">
  ...
  <table width="50%" border="0" cellspacing="1" cellpadding="2" bgcolor="#E9E9E9" align="center">
    <tr bgcolor="#C8D7E6"> 
      <td height="27" colspan="13" background="../graphics/table0_horizontal.PNG"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Setup 
    ...
    <?
		...
		?>
    <tr bgcolor="#FFFFFF"> 
      <td colspan="11" height="2" valign="bottom">&nbsp;</td>
    </tr>
    <tr bgcolor="#E9E9E9"> 
      <td colspan="9" height="20"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Saved 
        Categories</font></td>
    </tr>
    <?
	} //if insert
...
maxlength="40"  ></td>
	...
	?>
    <tr bgcolor="#FFFFFF"> 
      <td colspan="9" nowrap><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
