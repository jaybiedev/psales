...
<form action="" method="post" name="f1" id="f1">
  ...
  <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#EFEFEF">
    ...
    <tr bgcolor="#FFFFFF" onMouseOver="bgColor='#FFFFCC'" onMouseOut="bgColor='#FFFFFF'"> 
      ...
      <td><font size="2"><a href="javascript: document.getElementById('f1').action='?p=../backend/report.receipt&p1=Go&invoice=<?=$r->invoice;?>&terminal=<?=$r->terminal;?>'; document.getElementById('f1').submit()">Re-Print</a></font></td>
    </tr>
    <?
	}
	?>
