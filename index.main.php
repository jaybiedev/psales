...
<table width="100%75%" border="0" bgcolor="#FFFFFF">
  <tr>
    <td><img src="graphics/logo.jpg" width="160" height="50"></td>
  </tr>
</table>

<?
//echo "S ".$_SERVER['SERVER_ADDR'];
//echo "  R ".$_SERVER['REMOTE_ADDR'];
	...
	elseif($ADMIN['usergroup'] == 'B')
	{
		echo "<script>window.location='audit/'</script>";
		exit;
	}
	elseif($_SERVER['HTTP_HOST'] == '121.97.227.121')
	{
...
<div align="center">
  <p>User : 
    <?=$ADMIN['name'];?>
    @Terminal: <?= $SYSCONF['TERMINAL'].'.'.$term['DESCRIPTION'];?> db: <?=$SYSCONF['DATABASE'];?><br>
    Today is : 
    <?= date('F d, Y');?>
  </p>
  <p><h3>Press [ F11 ] To View FULL SCREEN
  <?
  if ($_SERVER['REMOTE_ADDR'] == '127.0.0.1')
  {
   	echo "<br><br><font color='red'>O-F-F-L-I-N-E POINT OF SALE</font>";
//	echo "SL $stockledger  SH $sales_header  SD $sales_detail";
 }
  ?>
  </h3></p>
</div>
<table width="50%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#EFEFEF">
  ...
  <tr bgcolor="#FFFFFF"> 
    <td><div align="center"><a accesskey='N' href="accounting/"><img src="graphics/query.jpg" width="67" 
height="62"><br>
        Accounting</a></div></td>
    <td><div align="center"><a accesskey='S' href="backend/"><img src="graphics/run.jpg" width="67" height="67"><br>
        System</a></div></td>
...
<br><div align='center'>
Price LookUp <input type='text' name='searchstock' size ="25" id='searchstock'  onKeypress="if(event.keyCode==13) {document.getElementById('pp').click();}">
<input type="button" name="pp" id="pp" value="Search" onClick="window.location='./inventory?p=plusearch&p1=Search&searchstock='+searchstock.value">
<br>
<?
if ($ADMIN['usergroup'] == 'A')
{
	...
	else
	{
		...
		echo "<a href='?p=&p1=SwDB'>Switch To Temporary/Test DataBase</a>";
	}
}
?>
<br><a href="./backend/?p=admin.cp">
Change Password</a>
</div>
<br>
<div align="center" valign=bottom><img src="graphics/worm_in_hole.gif" width="23" height="33"> 
  <br>
  <img src="graphics/elephantSmall.gif" width="50" height="50"> <img src="graphics/php-small-purple.gif" width="88" height="31"><img src="graphics/mysql-powered-by.JPG" width="50" height="50"><br>
...
<script>document.getElementById('searchstock').focus()</script>
